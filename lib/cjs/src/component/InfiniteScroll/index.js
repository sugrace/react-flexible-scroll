...
function InfiniteScroll(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: { height: productHeight * maximumRowLength }, children: (0, jsx_runtime_1.jsx)("div", { style: {
            ...
            }, children: React.Children.map(children, function (child) { return ((0, jsx_runtime_1.jsx)("div", { style: __assign({ width: productWidth, height: productHeight, flex: "0 1 ".concat(100 / productCountPerRow, "%") }, productStyle), children: React.cloneElement(child, { key: child.key }) })); }) }) }));
}
