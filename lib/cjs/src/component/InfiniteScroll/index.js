...
function InfiniteScroll(_a) {
    ...
    var _f = (0, react_1.useState)(productHeight * (maximumRowLength - visibleRowLength)), paddingBottom = _f[0], setPaddingBottom = _f[1];
    ...
    var setVisibleProductListByStartRowIndex = (0, react_1.useCallback)(function () {
    ...
    var getStartRowIndex = (0, react_1.useCallback)(function (scrollTop) {
    ...
    var handleScrollLayout = function (e) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var handleScrollFetch = function (e) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: { height: productHeight * maximumRowLength }, children: (0, jsx_runtime_1.jsx)("div", { style: {
                display: "flex",
                flexDirection: flexDirection,
                flexWrap: "wrap",
                paddingTop: paddingTop,
                paddingBottom: paddingBottom,
            }, children: react_1.default.Children.map(children, function (child) { return ((0, jsx_runtime_1.jsx)("div", { style: __assign({ width: productWidth, height: productHeight, flex: "0 1 ".concat(100 / productCountPerRow, "%") }, productStyle), children: react_1.default.cloneElement(child, { key: child.key }) })); }) }) }));
}
