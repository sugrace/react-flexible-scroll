...
function InfiniteScroll(_a) {
    ...
    return (_jsx("div", { style: { height: productHeight * maximumRowLength }, children: _jsx("div", { style: {
            ...
            }, children: React.Children.map(children, function (child) { return (_jsx("div", { style: __assign({ width: productWidth, height: productHeight, flex: "0 1 ".concat(100 / productCountPerRow, "%") }, productStyle), children: React.cloneElement(child, { key: child.key }) })); }) }) }));
}
